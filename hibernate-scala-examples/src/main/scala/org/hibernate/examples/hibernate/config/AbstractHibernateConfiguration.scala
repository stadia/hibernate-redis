...
import org.hibernate.cfg.{Environment, NamingStrategy}
import org.hibernate.{Interceptor, SessionFactory}
import org.springframework.context.annotation.{Bean, Configuration}
import org.springframework.dao.annotation.PersistenceExceptionTranslationPostProcessor
import org.springframework.orm.hibernate3.HibernateExceptionTranslator
import org.springframework.orm.hibernate3.{HibernateTransactionManager, LocalSessionFactoryBean}
...
abstract class AbstractHibernateConfiguration {
    ...
    def hibernateProperties(): Properties = {
        ...
        props.setProperty(Environment.POOL_SIZE, "30")
        props.setProperty(Environment.SHOW_SQL, "true")
        props.setProperty(Environment.FORMAT_SQL, "true")
        props.setProperty(Environment.AUTOCOMMIT, "true")
